...
int main() {
    ...
    for (int i = 0; i < testNum; i++) {
        ...
        ofstream report("./switchsketch128-zby -Report.txt");
        double AAEOfHH = 0;
        double AREOfHH = 0;
        for (unsigned int idx = 0; idx < estimatedFlowSizesVector.size(); idx++) {
        ...
        ofstream out("./switchsketch128-zby -m64 -O.txt", ios::app);
        out << "****************************-----test " << i << endl;
        ...
        ofstream real("./switchsketch128-zby -Real.txt");
        AAEOfHH = 0;
        AREOfHH = 0;
        for (unsigned int idx = 0; idx < actualFlowSizesVector.size(); idx++) {
