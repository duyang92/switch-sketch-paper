...
def switchsketch_2L4S(file, memory_size):
    bucket_array = []
    bucket_num = (memory_size*8*1024)//128
    for i in range(bucket_num):
        bucket = [ [None, "0000000000000000"] for j in range(2) ]
        bucket += [ [None, 0] for j in range(4) ]
...
if __name__ == "__main__":
    ...
    memory_size = 100
    bucket_array, est_label = switchsketch_2L4S(File, memory_size)
