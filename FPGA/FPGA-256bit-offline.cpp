...
void findMinCell(ap_uint<256> &bucket,int level,const int &num_lv1, const int &num_lv2, const int &num_lv3,uint16_t& min_counter,uint16_t& min_index){
    uint32_t fp_len;
    uint32_t ct_mask;
    uint32_t cell_len;
    uint32_t start,end;
...
void Switch(ap_uint<256> &bucket, int level, const int &num_lv_1, const int &num_lv_2, const int &num_lv_3, uint16_t fp16,uint32_t cell_start_bit_idx) {
